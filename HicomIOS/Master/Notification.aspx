...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">       
        function confirm_btn() {
            ...
            if (id == "" || id == null) { //Add Or Edit
                ...
                var customer = cbbCustomerID.GetSelectedItem();
                var type = cboNoticeType.GetSelectedItem();
                var subject = $("#subject");
                ...
                var parametersNotic = {
                    dataNotic: [{
                        ...
                        customer_id: cbbCustomerID.GetValue(),
                        notice_type: cboNoticeType.GetValue(),
                        notice_date: notice_date,
                        is_enable: btnto,
                        company_name_tha: cbbCustomerID.GetText()
                    }]
                };
                $.ajax({
                    type: "POST",
        ...
        function editItem(id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    cbbCustomerID.SetText(data.d.company_name_tha);
                    cbbCustomerID.SetEnabled(false);
        ...
        function addNewItem() {
            ...
            cbbCustomerID.SetText(" ");
            cbbCustomerID.SetEnabled(true);
    ...
    <div class="content">
        ...
        <div id="gridCell">
            <dx:ASPxGridView ID="gridView" runat="server" CssClass="gridResize" ClientInstanceName="gridView"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="customer_code" Caption="Customer Code" Width="100px" />
                    <dx:GridViewDataTextColumn FieldName="company_name_tha" Caption="Company Name" Width="100px" />
                    <dx:GridViewDataTextColumn FieldName="subject" Caption="Subject" Width="150px" />
                    <dx:GridViewDataTextColumn FieldName="description" Caption="Description" Width="150px" />
                    <dx:GridViewDataTextColumn FieldName="enable" Caption="Notice" Width="100px" />
                </Columns>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <dx:ASPxComboBox ID="cbbCustomerID" CssClass="form-control" runat="server"
                                                ClientInstanceName="cbbCustomerID" TextField="data_text" 
