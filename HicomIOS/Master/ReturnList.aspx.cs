...
namespace HicomIOS.Master
{
    public partial class ReturnList : MasterDetailPage
    {
        ...
        public override string PageName { get { return "Return List" + (string.IsNullOrEmpty(Request.QueryString["type"]) ? "" : " " + Request.QueryString["type"].ToUpper()); } }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strReturnType = string.IsNullOrEmpty(Request.QueryString["type"]) ? "IS" : Request.QueryString["type"].ToUpper();
