...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function editDeliveryNoteDetail(element, e) {
            var key = e;
            $('#hideSelectedIssueDetailId').val(key);
            $.ajax({
                type: "POST",
                ...
                success: function (response) {
                    ...
                    $('#modal_edit_delivery_note .modal-header').html('Edit Sale Order Detail : ' + element.title);
        ...
        <div class="row">
            <fieldset>
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-4 no-padding">
                        <div class="row form-group">
                            <label class="col-xs-3 text-right label-rigth">เลขที่ใบเบิกสินค้า :</label>
                    ...
                    <div class="col-xs-4 no-padding">
                        <div class="row form-group">
                            ...
                            <div class="col-xs-9 no-padding">
                                <input type="text" class="form-control txt-no" id="delivery_no" readonly="" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-xs-4 no-padding">
                        <div class="row form-group">
                            ...
                            <div class="col-xs-9 no-padding">
                                <input type="text" class="form-control" id="lbAttentionName" runat="server" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 no-padding">
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-xs-4 no-padding">
                        <div class="row form-group">
                            <label class="col-xs-3 text-right label-rigth">วันที่เสนอราคา :</label>
                            <div class="col-xs-9 no-padding">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-4 no-padding">
                        <div class="row form-group">
                            ...
                            <div class="col-xs-9 no-padding">
                                <input type="text" class="form-control hidden" id="lbSalesOrderNo" readonly="" runat="server" />
                                <input type="text" class="form-control" id="lbPONo" readonly="" runat="server" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 no-padding">
                        <div class="row form-group">
                            <label class="col-xs-3 text-right label-rigth">วันที่ใบสั่งซื้อลูกค้า :</label>
                            <div class="col-xs-9 no-padding">
                                <input type="text" class="form-control hidden" id="lbSalesOrderDate" readonly="" runat="server" />
                                <input type="text" class="form-control" id="lbPODate" readonly="" runat="server" />
                            </div>
                        </div>
                    </div>
                     <div class="col-xs-4 no-padding">
