<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DeliveryNoteList.aspx.cs" Inherits="HicomIOS.DeliveryNoteList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="gridCell">
        <dx:ASPxGridView ID="gridView" runat="server" AutoGenerateColumns="False" ClientInstanceName="deliveryNoteListGrid"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Print" FieldName="id" CellStyle-HorizontalAlign="Center" Width="30px">
                    <DataItemTemplate>
                        <a id="btnPrint" class="btn btn-mini" onclick="printDeliveryNote(<%# Eval("id")%>)" title="Print">
                            <i class="fa fa-print" aria-hidden="true"></i>
                        </a>
                    </DataItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="delivery_no" Caption="Delivery No" Width="100px">
                    <DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn FieldName="delivery_status_display" Caption="Status" Width="100px" />
                <dx:GridViewDataTextColumn FieldName="quotation_no" Caption="Quotation No" Width="100px" />
                <dx:GridViewDataTextColumn FieldName="saleorder_no" Caption="Sale Order No" Width="100px" />
                <dx:GridViewDataTextColumn FieldName="issue_no" Caption="Issue No" Width="100px" />
                <%--<dx:GridViewDataTextColumn FieldName="attention_name" Caption="Attention Name" Width="200px" />--%>
                <dx:GridViewDataTextColumn FieldName="customer_name" Caption="Customer Name" Width="300px" />
                <%--<dx:GridViewDataTextColumn FieldName="delivery_date" Caption="Delivery Date" Width="110px" />--%>
            </Columns>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            deliveryNoteListGrid.SetHeight(h - 155);
        });
        ASPxClientControl.GetControlCollection().BrowserWindowResized.AddHandler(function (s, e) {
            ...
            console.log(height);
            deliveryNoteListGrid.SetHeight(height);
        });
        function addNewItem() {
            window.location.href = "DeliveryNote.aspx";
        }
        function printDeliveryNote(e) {
            $.LoadingOverlay("show", {
                zIndex: 9999
            });
            var id = e;
            $.ajax({
                type: "POST",
                url: "DeliveryNoteList.aspx/GetDeliveryNoteData",
                data: '{id:"' + id + '"}',
                ...
                success: function (data) {
                    ...
                    window.open("../Report/DocumentViewer.aspx?ReportArgs=Delivery_Note|" + data.delivery_no, "_blank");
                    $.LoadingOverlay("hide");
                }
            });
        ...
        function searchDataGrid(e) {
            if (e == 13) {
                ...
                deliveryNoteListGrid.PerformCallback(txtSearch.toString());
        ...
        function editItem(e) {
            ...
            var key = e;
            window.location.href = "DeliveryNote.aspx?dataId=" + key;
            $.LoadingOverlay("hide");
        }
            ...
            swal({
               ...
               .then((willDelete) => {
                   if (willDelete) {
                       $.ajax({
                           type: "POST",
                           url: "DeliveryNoteList.aspx/DeleteDeliveryNote",
                           data: '{id:"' + e + '"}',
                           contentType: "application/json; charset=utf-8",
                           dataType: "json",
