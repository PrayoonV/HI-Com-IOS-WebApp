    ...
    <div id="gridCell">
        <dx:ASPxGridView ID="gridView" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridView"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="borrow_no" Caption="Borrow No" Width="80px">
                    <DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn FieldName="borrow_status_display" Caption="Status" Width="50px" />
                <dx:GridViewDataTextColumn FieldName="supplier_name" Caption="Supplier" Width="110px" />
                <dx:GridViewDataTextColumn FieldName="purchase_order_no" Caption="Purchase Order No" Width="110px" />
                <dx:GridViewDataTextColumn FieldName="customer_name" Caption="Customer" Width="140px" />
