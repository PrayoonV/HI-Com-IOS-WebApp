<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="EmployeePosition.aspx.cs" Inherits="HicomIOS.Master.EmployeePosition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="gridCell">
        <dx:ASPxGridView ID="gridView" runat="server" AutoGenerateColumns="False" ClientInstanceName="employeepositionGrid"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="name_tha" Caption="Name(THA)" Width="150px" Settings-AllowSort="True" SortOrder="Ascending" />
                <dx:GridViewDataTextColumn FieldName="name_eng" Caption="Name(ENG)" Width="150px" />
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-title">เพิ่มตำแหน่งงาน</div>
                    </div>
                    <div class="modal-body text-center">
                        <div class="row">
                            <div class="form-group col-xs-6 no-padding">
                                <label class="control-label col-xs-4 no-padding" for="positionNameTHA">Position Name(THA):</label>
                                <div class="col-xs-8">
                                    <input type="text" class="form-control" id="positionNameTHA" runat="server" />
                                </div>
                            </div>
                            <div class="form-group col-xs-6 no-padding">
                                <label class="control-label col-xs-4 no-padding" for="positionNameENG">Position Name(ENG):</label>
                                <div class="col-xs-8">
                                    <input type="text" class="form-control" id="positionNameENG" runat="server" />
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        var pageURL = "EmployeePosition.aspx";
        $(document).ready(function () {
            ...
            employeepositionGrid.SetHeight(h - 155);
        });
        ...
        ASPxClientControl.GetControlCollection().BrowserWindowResized.AddHandler(function (s, e) {
            ...
            console.log(height);
            employeepositionGrid.SetHeight(height);
        });
        function searchDataGrid(e) {
            if (e == 13) {
                ...
                employeepositionGrid.PerformCallback(txtSearch.toString());
        ...
        function NewItem() {
            $("#positionId").val("");
            $("#modal_form .modal-title").html("เพิ่มตำแหน่งงาน");
        ...
        function editItem(id, index) {
            ...
            $.ajax({
                type: 'POST',
                url: pageURL + "/GetEditPositionData",
                data: '{id: "' + id + '", index: ' + index + '}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (result) {

                    $('#positionNameTHA').val(result.d["name_tha"]);
                    $('#positionNameENG').val(result.d["name_eng"]);

                    $("#modal_form .modal-title").html("แก้ไขตำแหน่งงาน");
                    $("#modal_form").modal("show");
                }
            });
        }
            ...
            if (!isValid) {
                ...
                if (positionId == "") {
                    var parametersAdd = {
                        positionAddData: [
                            {
                                name_tha: $('#positionNameTHA').val(),
                                name_eng: $('#positionNameENG').val()
                            }
                        ]
                    };
        ...
        function changeStatusItem(id, e) {
            ...
            $.ajax({
                ...
                data: '{id: "' + id + '", is_enable: "' + is_enable + '", table_name: "tb_employee_position"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (result) {
                    if (result.d) {
