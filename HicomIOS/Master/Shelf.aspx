    ...
    <div id="gridCell">
        <dx:ASPxGridView ID="gridView" runat="server" AutoGenerateColumns="False" ClientInstanceName="notificationGrid"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="shelf_name" Caption="Name" Width="350px" Settings-AllowSort="True" SortOrder="Ascending" />
                 <dx:GridViewDataTextColumn Caption="Status" FieldName="is_enable" CellStyle-HorizontalAlign="Center" Width="45px">
                    <DataItemTemplate>
