 ...
 <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    ...
    <div id="gridCell">
        <dx:ASPxGridView ID="gridView" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridView"
            ...
            OnPageIndexChanged="gridView_PageIndexChanged" OnBeforeColumnSortingGrouping="gridView_BeforeColumnSortingGrouping">
            ...
            <Columns>
                <dx:GridViewDataTextColumn Caption="Manage" FieldName="id" CellStyle-HorizontalAlign="Center" Width="30px"   Settings-AllowSort="False">
                    <DataItemTemplate>
                        ...
                        <a id="btnEdit" class="btn btn-mini <%# ((bool)BasePage.SESSION_PERMISSION_SCREEN.is_edit) ? "" : "disabled" %>" onclick="editItem_Child(<%# Eval("id")%>, <%# Container.VisibleIndex %>)" title="Edit">
                ...
                <dx:GridViewDataTextColumn FieldName="cat_type" Caption="Category Type" Width="50px" Settings-AllowSort="True" SortOrder="Ascending" />
                <dx:GridViewDataTextColumn FieldName="cat_name_tha" Caption="Category Name (THA)" Width="110px" />
                <dx:GridViewDataTextColumn FieldName="cat_name_eng" Caption="Category Name (ENG)" Width="110px" />
    ...
    <script type="text/javascript">
        ...
        function editItem_Child(id, index) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.d != 0) {
                        ...
                        alertWarning("ไม่พบรายละเอียดข้อมูลนี้")
                        location.reload();
                    }
                }
            });
