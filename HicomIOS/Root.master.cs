    ...
    public partial class RootMaster : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                ASPxLabel2.Text = DateTime.Now.Year + Server.HtmlDecode(" &copy; Copyright by Hi-Com Corporation (Thailand). [เว็บไซต์นี้เหมาะกับจอความละเอียดกว้าง 1366px ขึ้นไป] v1.0.7");
                LoadTopMenu();
            }
            catch (Exception ex)
            {
